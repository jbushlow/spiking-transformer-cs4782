...
from nlu.nlu_dataset import MRDataset
...
def main():
    ...
    parser.add_argument("--output_dir", default="results/nlu_checkpoints/mr_46m")
    ...
    train_dataset = MRDataset(split='train')
    val_dataset = MRDataset(split='validation')
